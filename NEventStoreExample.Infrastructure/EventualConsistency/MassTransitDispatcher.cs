namespace NEventStoreExample.Infrastructure.EventualConsistency
{
  ...
  internal class MassTransitDispatcher : IObserver<ICommit>, IDisposable
  {
    ...
    {
      DispatchCommit(this.bus, commit);
    }
    ...
    //
    // Again, think of the current state of a domain object as what you get after all events that built it are applied.
    ...
    internal static void DispatchCommit(IEventPublisher bus, ICommit commit)
    {
